      <div class="sidebar card card-corner bg-dark col-4 me-5">
        ...
        <div class="nav d-flex flex-column">
          ...
          <a href="<?= BASE_URL ?>/monCompte" class="sidebar-link py-2 my-0 text-decoration-none active p-3">
            <i class="bi bi-person text-light me-1"></i>
            <span class="hide-on-collapse text-light">Profile</span>
          </a>

          <a href="<?= BASE_URL ?>/monCompte/mesCommandes" class="sidebar-link py-2 my-0 text-decoration-none p-3">
            <i class="bi bi-cart text-light me-1"></i>
            <span class="hide-on-collapse text-light">Mes commandes</span>
          </a>

          <a href="#" class="sidebar-link py-2 my-0 text-decoration-none p-3">
